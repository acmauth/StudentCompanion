...
export default {
	el: {
		...
		"menu.midday_open": "Λέσχη ανοιχτή - Κλείνει στις 16:00",
		...
		'course.exam_winter_period': 'ΦΕΒΡΟΥΑΡΙΟΣ',
		'course.exam_summer_period': 'ΙΟΥΝΙΟΣ',
		'course.exam_autumn_period': 'ΣΕΠΤΕΜΒΡΙΟΣ',
	...
	en: {
		...
		'course.exam_winter_period': 'FEBUARY',
		'course.exam_summer_period': 'JUNE',
		'course.exam_autumn_period': 'SEPTEMBER',
