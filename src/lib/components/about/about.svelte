<script lang="ts">
	...
	const teamMembers = writable<TeamMember[]>([]);
			...
			<div class="card-content">
				...
				<div class="section">
					...
					<p style="font-size: 14px;">
						{$t('about.who_are_we_text_1')} <br /> <br />
						{$t('about.who_are_we_text_2')} <a href="https://auth.acm.org/">ACM AUTh</a>
						{$t('about.who_are_we_text_3')}
					</p>
				</div>
