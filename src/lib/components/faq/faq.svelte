<script lang="ts"> 
    const faqs = [
        ...
        { id: 8, title: "Θέλω να προτείνω μερικές ιδέες για την εφαρμογή", answer: "Θα χαρούμε πάρα πολύ να ακούσουμε τι έχεις να μας πεις!<br> Μπορείς να προτείνεις ιδέες μέσω της φόρμας \"Πες μας την άποψή σου\" στην κεντρική σελίδα της εφαρμογής." },
    ];
