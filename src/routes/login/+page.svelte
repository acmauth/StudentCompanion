                            ...
                            <ion-accordion-group  expand="inset">
                                <ion-accordion value="first">
                                    ...
                                    <div class="ion-padding" slot="content">
                                        Αυτή τη στιγμή, όταν συνδέεσαι στην εφαρμογή, το ΑΠΘ μας δίνει πρόσβαση στα στοιχεία σου για έως και 7 ώρες. Αυτό είναι αρκετό για χρήση σε ιστοσελίδες, αλλά δεν βολεύει για εφαρμογές στο κινητό, όπως η δική μας. Έχουμε ήδη ενημερώσει το ΑΠΘ για το πρόβλημα και περιμένουμε να μας δώσουν μια λύση.
                                    </div>
                                </ion-accordion>
