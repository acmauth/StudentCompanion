<script>
    ...
    function updateGrades() 
    {
        ...
        for (const semesterCourses of unpassed_semesters)
        {
        ...
        degree_grade = ((sum_unpassed_semesters+sum_passed_courses) / ectsSumAll);
        degree_grade_string = String(degree_grade.toFixed(2));
    }
</script>
...
<ion-content>
        ...
        <div class="center-div">
            ...
            <ion-card class="ion-padding">
                <ion-card-header class="ion-text-center info">
                    <ion-card-title>Βαθμός πτυχίου: {degree_grade_string}</ion-card-title>
                </ion-card-header>
            </ion-card>
        </div>
...
<style>  
    ...
    /* Style the number input when it's being hovered */
