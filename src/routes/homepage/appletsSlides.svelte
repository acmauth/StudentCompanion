...
<ion-content scroll-x={true} scroll-y={false} style="max-height: 6.5rem" class="ion-padding scrollingApplets">
    <div class="applets">
    <AppCard colour="orange" margin={false} shadow={false} class="applet" maxWidth="9rem" href="/menu">
        <div class="appletcontent">
            <ion-icon icon={fastFood}></ion-icon>
            <ion-label>Μενού Λέσχης</ion-label>
        </div>
    </AppCard>
    <AppCard colour="green" margin={false} shadow={false} class="applet" maxWidth="9rem" href="/maps">
        <div class="appletcontent">
            <ion-icon icon={map}></ion-icon>
            <ion-label>Χάρτης ΑΠΘ</ion-label>
        </div>
    </AppCard>
    <AppCard colour="purple" margin={false} shadow={false} class="applet" maxWidth="9rem" href="/quicklinks">
        <div class="appletcontent">
